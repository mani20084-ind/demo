...
def mock_ai_planner(requirement_text):
    """
    SIMULATED AI: In a real scenario, this would call Gemini.
    For the POC, it returns a fixed list of tasks based on the input.
    """
    print(f"🤖 AI is analyzing requirement: {requirement_text[:50]}...")
    
    # These would be generated by Gemini later
    return [
